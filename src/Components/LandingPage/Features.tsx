...
const Features: React.FC = () => {
    return (
        <div className="flex justify-center">
            <div className="mt-20 w-[1300px] h-[500px]">
                {/* Header */}
                <div className="flex justify-center">
                ...
                <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="p-6 rounded-lg shadow-sm flex flex-col items-start gap-4 w-[300px] mx-auto">
                    ...
                    <div className="p-6 rounded-lg shadow-sm flex flex-col items-start gap-4 w-[250px] mx-auto">
                        <div className=" bg-blue-100  rounded-full p-2">
                    ...
                    <div className="p-6 rounded-lg shadow-sm flex flex-col items-start gap-4 w-[250px] mx-auto">
                        <div className=" bg-blue-100  rounded-full p-2">
                            < SiTicktick size={50} className="text-[#4D8FFAE5]" />
                        </div>
                        <div>
                    ...
                    <div className="p-6 rounded-lg shadow-sm flex flex-col items-start gap-4 w-[300px] mx-auto">
                        <div className=" bg-blue-100  rounded-full p-2">
                            < FiPieChart size={50} className="text-[#4D8FFAE5] text-sm" />
                        </div>
                        <div>
